        ...
        try {
            switch (item.getItemId()){
                ...
                case  R.id.Logout:
                    ...
                    startActivity(new Intent(MainActivity2.this, StartActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                    return true;
            }

        }catch (Exception e){
            System.out.println("DAKJSFHJKSD");
